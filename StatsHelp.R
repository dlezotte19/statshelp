...
#' 
#' This function shows you how to compute standard error.
#' @param standard deviation(s) and sample size(n)
#' @keywords Standard error
#' @export
#' @examples stdEr(15,200)
#' stdEr()
...
#ztest for proportions example
ztestp(n = 46,p = .6,phat = .7)
ztestp(SE = .07, p = .6, phat = .7)
...
#ttest example
ttest(n=46,s=1800,xbar=13200,mu=12800)
ttest(n = 46, SE = 265, xbar = 13200, mu = 12800)

#2 sample ztest for means
...
#2sample ztest for means example
ztest2s(n1=45,n2=52,s1=1.4,s2=1.6,xbar1=42.1,xbar2=42.7)

#2 sample ttest for means
...
#2 sample ttest for means example
ttest2s(n1=45,n2=52,s1=1.4,s2=1.6,xbar1=42.1,xbar2=42.7)
